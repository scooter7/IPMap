...
XLSX_PATH   = '/Users/scootervineburgh/Desktop/Kathi/Apollo Large.xlsx'
OUTPUT_PATH = '/Users/scootervineburgh/Desktop/Kathi/apollo_large_click_map.html'
...
clicks_ws = wb['Apollo Large Clicks']
...
html = (HTML_TEMPLATE
        ...
        .replace('Apollo Clicks &rarr; Company Map', 'Apollo Large Clicks &rarr; Company Map')
        .replace('apollo_ip_company_matches', 'apollo_large_ip_company_matches')
        .replace('apollo_clicks_by_company', 'apollo_large_clicks_by_company'))
